...
('light_a1b2c3d4', '00:1A:22:33:44:55', 'Ambient Ceiling Light', 'light', 'Living Room', 'movie', 'off'),
('light_e5f6g7h8', '00:1A:22:33:44:55', 'Task Lighting', 'light', 'Kitchen', 'custom', 'on'),
...
INSERT INTO alert_log (home_id, user_id, device_id, message, sent_status, created_at) VALUES
('00:1A:22:33:44:55', 'user_2uo5j6ahQyHx9FZDIPa80IZYdCs', 'door_q7r8s9t0', 'Connection lost with patio door sensor', 1, datetime('now', '-45 minutes')),
('00:1A:22:33:44:55', 'user_2uo5j6ahQyHx9FZDIPa80IZYdCs', 'window_c9d0e1f2', 'Tampering detected - Basement window sensor', 0, datetime('now', '-2 hours')),
('00:1A:22:33:44:55', 'user_2uo5j6ahQyHx9FZDIPa80IZYdCs', 'light_e5f6g7h8', 'Home security system: Switching to Away mode', 1, datetime('now', '-3 hours')),
('00:1A:22:33:44:55', 'user_2uo5j6ahQyHx9FZDIPa80IZYdCs', 'light_a1b2c3d4', 'Device offline - Living room light not responding', 0, datetime('now', '-4 hours')),
('00:1A:22:33:44:55', 'user_2uo5j6ahQyHx9FZDIPa80IZYdCs', 'window_g3h4i5j6', 'Security Warning: Entryway window opened while system armed', 1, datetime('now', '-5 hours')),
('00:1A:22:33:44:55', 'user_2uo5j6ahQyHx9FZDIPa80IZYdCs', 'light_i9j0k1l2', 'EMERGENCY: Smoke detected - Emergency lighting activated', 1, datetime('now', '-6 hours')),
('00:1A:22:33:44:55', 'user_2uo5j6ahQyHx9FZDIPa80IZYdCs', 'door_m3n4o5p6', 'SECURITY BREACH: Front door forced open - Contacting authorities', 1, datetime('now', '-7 hours')),
('00:1A:22:33:44:55', 'user_2uo5j6ahQyHx9FZDIPa80IZYdCs', 'window_y5z6a7b8', 'Connection lost with dining room window sensor', 0, datetime('now', '-8 hours')),
('00:1A:22:33:44:55', 'user_2uo5j6ahQyHx9FZDIPa80IZYdCs', 'light_i9j0k1l2', 'Night security mode: Pathway light activated', 1, datetime('now', '-9 hours')),
('00:1A:22:33:44:55', 'user_2uo5j6ahQyHx9FZDIPa80IZYdCs', 'light_e5f6g7h8', 'Low battery warning: Kitchen light (15% remaining)', 1, datetime('now', '-10 hours'));